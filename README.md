...
implr is a plugin of seven skills that take a project from a folder of business and technical
...
```
your-project/
├── .claude/skills/                 seven installed skills (SKILL.md each)
├── docs/
...
To change a requirement, edit the source document in `docs/kb/` and reprocess, rather than
editing the generated requirement file.
